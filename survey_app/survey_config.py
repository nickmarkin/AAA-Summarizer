    ...
    'subsections': [
        {
            ...
            'trigger': {
                ...
                'info_text': '<strong>UNMC Standing (1,000 pts):</strong> Admissions, GME, curriculum, senate; IRB or other with approval.<br><br><strong>NebMed Standing (500 pts):</strong> Nebraska Medicine standing MEC/med staff committee.<br><br><strong>Minor (100 pts):</strong> Minor or ad hoc Nebraska Medicine or UNMC committee.<br><br><strong>Other (0 pts):</strong> Committees that do not fit other categories.<br><br><em>Report once per academic year - this will carry forward to subsequent quarters.</em>',
            },
            'type': 'repeating',
        ...
        },
        {
            ...
            'trigger': {
                ...
                'type': 'yesno',
                'help_text': 'Select Yes to enter details below',
                'info_text': '<strong>Grand Rounds Host (300 pts):</strong> Pick up speaker, arrive early to set up computer, introduce speaker.<br><br><strong>Grand Rounds Attendance (50 pts):</strong> In-person attendance at departmental Grand Rounds.<br><br><strong>QA Meeting Attendance (50 pts):</strong> In-person attendance at Quality Assurance meetings.<br><br><strong>Journal Club Host (300 pts):</strong> Pick up speaker, department contact person for JC, drop off speaker.<br><br><strong>Journal Club Attendance (50 pts):</strong> In-person attendance at department or division Journal Club.<br><br><strong>Student Shadowing (50 pts):</strong> Per day of student shadowing.',
            },
            'type': 'repeating',
    ...
    'subsections': [
        {
            ...
            'trigger': {
                ...
                'type': 'yesno',
                'help_text': 'Select Yes to enter details below',
                'info_text': '<strong>UNMC Grand Rounds (500 pts):</strong> Present Grand Rounds to department.<br><br><strong>New Lecture (250 pts):</strong> Write and give a new lecture.<br><br><strong>Revised Lecture (100 pts):</strong> Give a revised/updated lecture.<br><br><strong>Existing Lecture (50 pts):</strong> Give an unrevised lecture.<br><br><strong>M&M/Practice Oral Boards (75 pts):</strong> Prepared and ran M&M or Practice Oral Boards session.<br><br><strong>Simulation Event - Resident/Fellow (150 pts):</strong> Prepared and ran a simulation for Residents/Fellows (includes Cardiac and CC Fellow sims).<br><br><strong>Core COM Faculty - New (500 pts):</strong> New lecture for College of Medicine core faculty.<br><br><strong>Core COM Faculty - Revised (250 pts):</strong> Revised lecture for COM core faculty.<br><br><strong>Ad Hoc COM Faculty - New (250 pts):</strong> New lecture for COM ad hoc faculty.<br><br><strong>Ad Hoc COM Faculty - Revised (100 pts):</strong> Revised lecture for COM ad hoc faculty.',
            },
            'type': 'repeating',
        ...
        },
        {
            ...
            'trigger': {
                ...
                'type': 'yesno',
                'help_text': 'Select Yes to enter details below',
                'info_text': '<strong>Mock Applied Exam Faculty (1,000 pts):</strong> Served as faculty for a mock applied (BASIC/ADVANCED) exam session.<br><br><strong>New OSCE Prep (250 pts):</strong> Created a new OSCE scenario or video for board preparation.<br><br><strong>OSCE Review (150 pts):</strong> Reviewed OSCE videos for residents - per 5 videos reviewed.<br><br><strong>OSCE/Oral Examiner (50 pts):</strong> Served as an examiner for mock oral board sessions - each session.',
            },
            'type': 'repeating',
        ...
        },
        {
            ...
            'trigger': {
                ...
                'type': 'yesno',
                'help_text': 'Select Yes to enter details below',
                'info_text': '<strong>Research Abstract (500 pts):</strong> Mentored trainee on research abstract submission.<br><br><strong>Poster Presentation (250 pts):</strong> Mentored trainee on poster for MARC/ASA/SCA.<br><br><strong>Presentation (100 pts):</strong> Helped trainee prepare for oral presentation. Must provide evidence of mentoring or have faculty identify mentor.<br><br><strong>Publication (100 pts):</strong> Guided trainee through publication process. Must provide evidence of mentoring or have faculty identify mentor.<br><br><strong>Resident Advisor (50 pts):</strong> Served as formal advisor to assigned resident.',
            },
            'type': 'repeating',
        ...
        },
        {
            ...
            'trigger': {
                ...
                'info_text': '<strong>Rotation Director (500 pts):</strong> Responsible for overseeing a specific clinical rotation for residents or fellows. Content must be updated yearly. List each rotation you direct separately.<br><br><em>Report once per academic year - this will carry forward to subsequent quarters.</em>',
            },
            'type': 'repeating',
    ...
    'subsections': [
        {
            ...
            'trigger': {
                ...
                'type': 'yesno',
                'help_text': 'Select Yes to enter details below',
                'info_text': '<strong>NIH Study Section - Standing (5,000 pts):</strong> Regular member of an NIH study section.<br><br><strong>NIH Study Section - Ad Hoc (2,500 pts):</strong> Served as an ad hoc reviewer for an NIH study section.<br><br><em>Report once per academic year - this will carry forward to subsequent quarters.</em>',
            },
            'type': 'repeating',
        ...
        },
        {
            ...
            'trigger': {
                ...
                'type': 'yesno',
                'help_text': 'Select Yes to enter details below',
                'info_text': 'Report grants that were <strong>awarded</strong> (funded) this quarter. Select tier based on direct costs:<br><br><strong>$100,000+ (5,000 pts):</strong> Major grants (R01, large foundation grants).<br><br><strong>$50,000-99,999 (3,000 pts):</strong> Mid-size grants.<br><br><strong>$10,000-49,999 (2,500 pts):</strong> Smaller grants, pilot funding.<br><br><strong>Under $10,000 (1,500 pts):</strong> Small grants, seed funding.<br><br>If you are not the PI, indicate the PI name.',
            },
            'type': 'repeating',
        ...
        },
        {
            ...
            'trigger': {
                ...
                'type': 'yesno',
                'help_text': 'Select Yes to enter details below',
                'info_text': 'Report grants <strong>submitted</strong> this quarter (regardless of outcome):<br><br><strong>Scored (2,000 pts):</strong> Your grant was reviewed and received a score.<br><br><strong>Not Scored (500 pts):</strong> Your grant was reviewed but not scored (triaged/not discussed).<br><br><strong>Mentor (250 pts):</strong> Served as mentor on trainee\'s grant submission. Must provide evidence of mentoring or have faculty identify mentor.',
            },
            'type': 'repeating',
    ...
    'subsections': [
        {
            ...
            'trigger': {
                ...
                'type': 'yesno',
                'help_text': 'Select Yes to enter details below',
                'info_text': '<strong>Course Director - National/International (3,000 pts):</strong> Directed a course at a national or international meeting (ASA, SCA, etc.).<br><br><strong>UNMC Course Director (1,000 pts):</strong> Directed a course at UNMC.<br><br><strong>Workshop Director (500 pts):</strong> Directed a hands-on workshop or skills session.<br><br><strong>Panel Moderator (250 pts):</strong> Moderated a panel discussion at a meeting.<br><br><strong>UNMC Moderator (100 pts):</strong> Moderated a session at UNMC.<br><br><strong>Guideline Writing (1,000 pts):</strong> Led the development of clinical guidelines.',
            },
            'type': 'repeating',
        ...
        },
        {
            ...
            'trigger': {
                ...
                'type': 'yesno',
                'help_text': 'Select Yes to enter details below',
                'info_text': '<strong>Society BOD Member (5,000 pts):</strong> Serve on the Board of Directors of a professional society (ASA, SCA, SOAP, etc.).<br><br><strong>Society RRC Member (5,000 pts):</strong> Serve on the Residency Review Committee.<br><br><strong>Major Board Committee Chair (3,000 pts):</strong> Chair a major committee of a professional society.<br><br><strong>Major Board Committee Member (1,000 pts):</strong> Serve as a member of a major society committee.<br><br><em>Report once per academic year - this will carry forward to subsequent quarters.</em>',
            },
            'type': 'repeating',
        ...
        },
        {
            ...
            'trigger': {
                ...
                'type': 'yesno',
                'help_text': 'Select Yes to enter details below',
                'info_text': '<strong>Boards Editor (5,000 pts):</strong> Serve as an editor for ABA or subspecialty board examinations.<br><br><strong>Writing Committee Chair (3,000 pts):</strong> Chair a question-writing committee for board exams.<br><br><strong>Board Examiner (2,000 pts):</strong> Serve as an oral board examiner.<br><br><strong>Question Writer (1,000 pts):</strong> Write questions for board examinations.<br><br><em>Report once per academic year - this will carry forward to subsequent quarters.</em>',
            },
            'type': 'repeating',
    ...
    'subsections': [
        {
            ...
            'trigger': {
                ...
                'type': 'yesno',
                'help_text': 'Select Yes to enter details below',
                'info_text': 'Report <strong>invited</strong> speaking engagements outside of your regular UNMC teaching duties:<br><br><strong>International/National Lecture (500 pts):</strong> Invited lecture at a national or international meeting.<br><br><strong>Regional/UNMC Lecture (250 pts):</strong> Invited lecture at a regional meeting or UNMC event.<br><br><strong>National Workshop (250 pts):</strong> Hands-on workshop at national meeting.<br><br><strong>Regional/UNMC Workshop (100 pts):</strong> Hands-on workshop at regional meeting or UNMC.<br><br><strong>Visiting Professor Grand Rounds (500 pts):</strong> Invited as visiting professor to give Grand Rounds elsewhere.<br><br><strong>Non-Anesth UNMC Grand Rounds (250 pts):</strong> Present Grand Rounds to other department at UNMC.',
            },
            'type': 'repeating',
        ...
        },
        {
            ...
            'trigger': {
                ...
                'type': 'yesno',
                'help_text': 'Select Yes to enter details below',
                'info_text': 'Report peer-reviewed publications that were <strong>published</strong> (not just accepted) this quarter.<br><br>Points calculated based on role × Impact Factor (IF):<br><br><strong>First/Senior Author (1,000 pts × IF):</strong> IF = 1 if low, otherwise max IF = 15.<br><br><strong>Co-author (300 pts × IF):</strong> Same IF calculation.<br><br>Enter the journal\'s Impact Factor (capped at 15 for calculation purposes).',
            },
            'type': 'repeating',
        ...
        },
        {
            ...
            'trigger': {
                ...
                'type': 'yesno',
                'help_text': 'Select Yes to enter details below',
                'info_text': 'Clinical pathways are standardized care protocols for specific clinical situations.<br><br><strong>New Pathway (300 pts):</strong> Created a new pathway from scratch.<br><br><strong>Review and Update Existing Pathway (150 pts):</strong> Made significant updates to an existing pathway.<br><br><em>Report once per academic year - this will carry forward to subsequent quarters.</em>',
            },
            'type': 'repeating',
        ...
        },
        {
            ...
            'trigger': {
                ...
                'type': 'yesno',
                'help_text': 'Select Yes to enter details below',
                'info_text': 'Report abstracts/posters <strong>presented</strong> at meetings this quarter (MARC, ASA, SCA, etc.):<br><br><strong>First/Senior Author (500 pts):</strong> You are the presenting author or senior/corresponding author.<br><br><strong>Second Author with Trainee First Author (500 pts):</strong> A trainee is first author and you are second (mentorship credit).<br><br><strong>Co-author (250 pts):</strong> You are a contributing author but not first, second, or senior.',
            },
            'type': 'repeating',
        ...
        },
        {
            ...
            'trigger': {
                ...
                'type': 'yesno',
                'help_text': 'Select Yes to enter details below',
                'info_text': '<strong>Editor-in-Chief (20,000 pts):</strong> Chief editor of a peer-reviewed journal.<br><br><strong>Section Editor (10,000 pts):</strong> Editor of a specific section within a journal.<br><br><strong>Special Edition Editor (10,000 pts):</strong> Guest editor for a special issue or supplement.<br><br><strong>Editorial Board Member (5,000 pts):</strong> Serve on the editorial board of a peer-reviewed journal.<br><br><strong>Ad Hoc Reviewer (1,000 pts):</strong> Must complete 4+ reviews in the same year for the same journal to qualify.<br><br><em>Report once per academic year - this will carry forward to subsequent quarters.</em>',
            },
            'type': 'repeating',
